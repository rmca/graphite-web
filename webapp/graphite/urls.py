...
urlpatterns = patterns('',
  ...
  ('^(?P<userid>[a-z0-9]{8})/graphite/render/?', include('graphite.render.urls')),
  ('^cli/?', include('graphite.cli.urls')),
  ('^(?P<userid>[a-z0-9]{8})/graphite/composer/?', include('graphite.composer.urls')),
  ('^(?P<userid>[a-z0-9]{8})/graphite/metrics/?', include('graphite.metrics.urls')),
  ('^(?P<userid>[a-z0-9]{8})/graphite/browser/?', include('graphite.browser.urls')),
